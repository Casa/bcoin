...
class HDPrivateKey {
  ...
  fromSeed(seed) {
    ...
    // UPDATE: the following check has been removed for the iOS
    // build to function. It may be incorrectly throwing an error for
    // seed phrases that use 21 words, as the original iOS app used.
